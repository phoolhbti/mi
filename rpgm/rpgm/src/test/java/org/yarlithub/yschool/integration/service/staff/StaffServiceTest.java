...
public class StaffServiceTest {
    ...
    public  void setup(){
        ...
        while (iterator.hasNext()){
            ...
            Staff result=staffService.addStaff((String)studentData[0],(String)studentData[1],(String)studentData[2],null);
    ...
    public void saveOrUpdateTest(){
        ...
        Staff result=staffService.addStaff((String)staffdata[0],(String)staffdata[1],(String)staffdata[2],null);
        while (iterator.hasNext()){
