package org.yarlithub.yschool.init.userSetUP;
...
//        DataLayerYschool.flushSession();
        ...
        SQLQuery insertQuery = DataLayerYschool.createSQLQuery(InitDBQueries.INSERT_USER);
        ...
        insertQuery.setTimestamp("modified_time", new java.util.Date());
