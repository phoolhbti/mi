...
public class ExaminationNewBean implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2218789497624315853L;
    ...
    public void init() {
        ...
        setAvailableSubjects(this.examinationService.getAvailableSubjects());
    }
    ...
    public String addCAExam() {
        logger.info("[ySchool]: Adding new CA Exam 1");
