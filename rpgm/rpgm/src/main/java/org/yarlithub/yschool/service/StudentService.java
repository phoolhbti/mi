...
public class StudentService {
     ...
     */
    @Transactional
    public Student addNewStudent(String addmision_No, String name, String fullname, String name_wt_initial, Date dob, String gender, String address,byte[] file) {
        StudentCreator studentCreator=new StudentCreator();
        Student student = studentCreator.addNewStudent(addmision_No, name, fullname, name_wt_initial, dob, gender, address,file);
        return student;
    }
